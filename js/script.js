const arrayData = [
  {
    ...
    in_test: "<tr><td>Vodka</td><td>2 oz</td></tr><tr><td>Fresh Lime Juice</td><td>1/2 lime</td></tr><tr><td>Ginger Beer</td><td>4 oz</td></tr><tr><td>Lime Wedge</td><td>Garnish</td></tr>"
  ...
  },
  {
    ...
    in_test: "<td>Vodka</td><td>1 1/2 oz</td></tr><tr><td>Triple Sec</td><td>1 oz</td></tr><tr><td>Lime Juice</td><td>1 oz</td></tr><tr><td>Lime Wedge</td><td>Garnish</td>"
  ...
  },
  {
    ...
    in_test: "<tr><td>Whiskey</td><td>1 1/2 oz</td></tr><tr><td>Lemon Juice</td><td>1/2 oz</td></tr><tr><td>Simple Syrup</td><td>1/2 oz</td></tr><tr><td>Sour Cherry</td><td>1</td></tr>"
  ...
  },
  {
    ...
    recipe: "https://chilledmagazine.com/jack-daniels-tennessee-honey-cocktails-for-national-whiskey-sour-day/",
    strength: 2,
    rating: "N/A",
    ingredients: [
    ...
    in_test: "<tr><td>Honey Whiskey</td><td>2 oz</td></tr><tr><td>Lemon Juice</td><td>2 oz</td></tr><tr><td>Water</td><td>1 oz</td></tr><tr><td>Orange Peels</td><td>Garnish</td></tr><tr><td>Sour Cherries</td><td>2</td></tr>"
  ...
  },
  {
    ...
    in_test: "<tr><td>Whiskey</td><td>1 1/2 oz</td></tr><tr><td>Water</td><td>1 tsp</td></tr><tr><td>Angostura bitters</td><td>2 Drops</td></tr><tr><td>Orange Wedge</td><td>1</td></tr><tr><td>Sour Cherry</td><td>1</td></tr><tr><td>Simple Syrup</td><td>2 tsp</td></tr>"
  ...
  },
  {
    ...
    in_test: "<tr><td>Dark Rum</td><td>2 oz</td></tr><tr><td>Ginger Beer</td><td>4-6 oz</td></tr><tr><td>Lime Juice</td><td>1 oz</td></tr><tr><td>Lime Wedge</td><td>Garnish</td></tr>"
  ...
  },  
  {
    ...
    in_test: "<tr><td>Honey Whiskey</td><td>2 oz</td></tr><tr><td>Mint Leaves</td><td>A few</td></tr><tr><td>Lemon Juice</td><td>1/2 oz</td></tr><tr><td>Simple Syrup</td><td>1/2 0z</td></tr><tr><td>Crushed Ice</td><td>N/A</td></tr>"
  ...
  },
  {
    ...
    in_test: "<tr><td>Honey Whiskey</td><td>2 oz</td></tr><tr><td>Ginger Beer</td><td>4-6 oz</td></tr><tr><td>Lemon Wedge</td><td>Garnish</td></tr>"
  ...
  // },
  {
    ...
    in_test: "<tr><td>Tequila</td><td>1 1/2 oz</td></tr><tr><td>Triple Sec</td><td>3/4 oz</td></tr><tr><td>Lemon Juice</td><td>1/2 oz</td></tr><tr><td>Orange Juice</td><td>4-5 oz</td></tr><tr><td>Grenadine</td><td>1/2 oz</td></tr>"
  ...
  },
  {
    ...
    in_test: "<tr><td>Vodka</td><td>1 1/2 oz</td></tr><tr><td>Clamato</td><td>4 oz</td></tr><tr><td>Caesar Seasoning</td><td>Rim glass</td></tr><tr><td>Lime Juice</td><td>1/2 tsp</td></tr><tr><td>Worcestershire Sauce</td><td>2 Dashes</td></tr><tr><td>Tabasco</td><td>2 Dashes</td></tr><tr><td>Celery</td><td>1 rib</td></tr>"
  ...
  },
  {
    ...
    recipe: "https://www.allrecipes.com/recipe/228491/the-real-long-island-iced-tea/",
    strength: 3,
    rating: "N/A",
    ingredients: [
      { "What": "Whiskey", "Qty": "2 1/2 oz" },
    ...
    in_test: "<tr><td>Vodka</td><td>1/2 oz</td></tr><tr><td>Rum</td><td>1/2 oz</td></tr><tr><td>Tequila</td><td>1/2 oz</td></tr><tr><td>Triple Sec</td><td>1/2 oz</td></tr><tr><td>Sweet and Sour Mix</td><td>1 oz</td></tr><tr><td>Cola</td><td>1 oz or to taste</td></tr><tr><td>Lemon</td><td>1 Slice</td></tr>"
...
function calc_Str(strength){
  ...
  var returnArray = []
    if (strength == 1){
      console.log("Str 1")
      returnArray.push("border-end rounded-start border-3 border-light col-3 level tasting-bar active");
      returnArray.push("border-start border-end border-light col-3 level tasting-bar");
      returnArray.push("border-start rounded-end border-3 border-light col-3 level tasting-bar");
  }else if(strength == 2){
      console.log("Str 2")
      returnArray.push("border-end rounded-start border-3 border-light col-3 level tasting-bar active");
      returnArray.push("border-start border-end border-light col-3 level tasting-bar active");
      returnArray.push("border-start rounded-end border-3 border-light col-3 level tasting-bar");
  }else if (strength == 3){
      console.log("Str 3")
      returnArray.push("border-end rounded-start border-3 border-light col-3 level tasting-bar active");
      returnArray.push("border-start border-end border-light col-3 level tasting-bar active");
      returnArray.push("border-start rounded-end border-3 border-light col-3 level tasting-bar active");
  }
  return returnArray
}
              ...
              <div class="col-sm-12 col-md-6 order-sm-2 order-md-2">
                ...
                <div class="row ranking-container">
                  <h4 class="poppins-regular-italic" style="padding-top:5px; margin-bottom: 10px";>Rating</h4>
                    <div class="col-2 star-ranking"><span class="star-ranking">${data.rating}</span> <div class="${hasStar}" style="color: #576e52;"></div></div>
